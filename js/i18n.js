...
const translations = {
  en: {
    ...
    "labPage.pieceTwoText": "The WebGL scene behind the homepage hero: a contour map drawn in the brand's gold and navy that swells on arrival, rises toward the cursor, and flattens back to a horizon as you scroll. Written as one shader, loaded only where a GPU can carry it.",
  ...
  es: {
    ...
    "labPage.pieceTwoTitle": "Signal Terrain",
    "labPage.pieceTwoText": "La escena WebGL detrás del hero: un mapa de contornos en el oro y navy de la marca que se hincha al llegar, se eleva hacia el cursor y se aplana en un horizonte con el scroll. Un solo shader, cargado solo donde una GPU puede con él.",
